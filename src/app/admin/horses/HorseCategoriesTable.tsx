...
// // import { Button } from "@/components/ui/button";
// import { createHorseCategory, deleteHorseCategory, readHorseCategories } from "@/lib/graphql";
...
//   const handleDelete = async (id: string) => {
//     const deleted = await deleteHorseCategory({ id })
//     if (deleted) setCategories(prev => prev.filter(el => el.id !== id))
//   }
...
//     <p>{error}</p>
//   </div>;
//   // if (!categories.length) return <div className="p-8 text-center text-neutral-500 border border-neutral-300 rounded-lg bg-neutral-50 dark:bg-neutral-900 dark:border-neutral-700">No horse Categories found.</div>;
